...
roji.page.Checkout = function(options, element) {
  ...
  this.options = $.extend(this.options, roji.page.Checkout.DEFAULT, options);


  // variables for update_checkout_bg_width
  this.sidebar_bg = $('#page-checkout-content-section-bg .sidebar-bg');
  this.content_bg = $('#page-checkout-content-section-bg .content-bg');
  this.sidebar_width = $('#page-checkout-sidebar-width');
  this.content_width = $('#page-checkout-content-width');
  
  
  // variables for update_checkout_bg_height
  this.desktop_title_section = $('#page-checkout-title-section');
  this.section_bg = $('#page-checkout-content-section-bg');
