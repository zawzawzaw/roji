...
roji.page.Account.prototype.update_account_bg_height = function(){
  ...
  if (manic.IS_MOBILE == false) {
    ...
    console.log(this.desktop_header_element.outerHeight())
    console.log(this.desktop_footer_element.outerHeight())
    console.log(this.desktop_title_section.outerHeight())
