...
manic.ui.HoverItem=function(options,element){goog.events.EventTarget.call(this);this.options=$.extend({},manic.ui.HoverItem.DEFAULT,options);this.element=element;this.is_inside=false;this.is_animating=false;this.on_element_mouseenter=function(event){this.is_inside=true;if(manic.IS_MOBILE==false)if(this.is_animating==false){this.is_animating=true;this.element.addClass("hover-version");TweenMax.killDelayedCallsTo(this.on_element_mouseenter_delayed);TweenMax.delayedCall(.55,this.on_element_mouseenter_delayed,
...
manic.ui.VideoContainer.prototype.on_element_click=function(event){if(this.is_ready==true)if(manic.IS_MOBILE==true)this.player.play()};manic.ui.VideoContainer.prototype.on_event_handler_04=function(event){};goog.provide("roji.component.DesktopHeader");goog.require("goog.events.Event");goog.require("goog.events.EventTarget");roji.component.DesktopHeader=function(options,element){goog.events.EventTarget.call(this);this.options=$.extend({},roji.component.DesktopHeader.DEFAULT,options);this.element=element;console.log("roji.component.DesktopHeader: init")};goog.inherits(roji.component.DesktopHeader,goog.events.EventTarget);roji.component.DesktopHeader.DEFAULT={"option_01":"","option_02":""};
...
roji.component.HomeInstagramSlider.prototype.on_after_instafeed_create_html=function(event){this.create_slider();this.dispatchEvent(new goog.events.Event(roji.component.HomeInstagramSlider.ON_INSTAGRAM_FEED_GENERATED))};goog.provide("roji.component.HomeMasonry");goog.require("goog.events.Event");goog.require("goog.events.EventTarget");roji.component.HomeMasonry=function(options,element){goog.events.EventTarget.call(this);this.options=$.extend({},roji.component.HomeMasonry.DEFAULT,options);this.element=element;this.isotope=null;this.create_isotope();console.log("roji.component.HomeMasonry: init")};goog.inherits(roji.component.HomeMasonry,goog.events.EventTarget);roji.component.HomeMasonry.DEFAULT={};
...
roji.component.MailingList=function(options,element){goog.events.EventTarget.call(this);this.options=$.extend({},roji.component.MailingList.DEFAULT,options);this.element=element;this.black_bg=this.element.find(".black-bg");this.close_btn=this.element.find("#mailing-list-close-btn");this.is_open=false;this.cookies=goog.net.cookies;this.black_bg.click(function(event){this.close_popup()}.bind(this));this.close_btn.click(function(event){this.close_popup()}.bind(this));var cookie_value=this.cookies.get("rojimailinglist");
...
roji.component.MobileHeader=function(options,element){goog.events.EventTarget.call(this);this.options=$.extend({},roji.component.MobileHeader.DEFAULT,options);this.element=element;this.is_open=false;this.element.find("#mobile-menu-btn").click(function(event){event.preventDefault();if(this.is_open==true)this.close_header();else this.open_header()}.bind(this));this.expand_container=$("#mobile-header-expanded");this.body_element=$("body");console.log("roji.component.MobileHeader: init")};
...
[];this.scrolltarget_name_array=[];this.preloader_element=$("#page-preloader");this.dropdown_array=[];this.form_check_array=[];this.manic_image_array=[];this.manic_video_array=[];this.expand_container_array=[];this.hover_item_array=[];this.previous_scroll_position=0;this.page_wrapper=$("#page-wrapper");this.mobile_header_spacer_element=$("#mobile-header-spacer");this.mobile_header_element=$("#mobile-header");this.desktop_header_spacer_element=$("#desktop-header-spacer");this.desktop_header_element=
$("#desktop-header");this.controller=null;this.check_browser();this.check_browser_size();this.check_actual_device();this.check_device();TweenMax.delayedCall(.4,this.init,[],this)};goog.inherits(manic.page.Page,goog.events.EventTarget);manic.page.Page.DEFAULT={"on_init_complete":function(){}};
...
manic.page.Page.prototype.create_video_container=function(){var arr=$(".manic-video-container").not(".not-default-version");var video_container=null;var item=null;for(var i=0,l=arr.length;i<l;i++){item=$(arr[i]);video_container=new manic.ui.VideoContainer({},item);this.manic_video_array[this.manic_video_array.length]=video_container}};
...
manic.page.Page.prototype.create_hover_item=function(){var arr=$(".manic-hover-item");var item=null;var hover_item=null;for(var i=0,l=arr.length;i<l;i++){item=$(arr[i]);hover_item=new manic.ui.HoverItem({},item);this.hover_item_array[this.hover_item_array.length]=hover_item}};
...
manic.page.Page.prototype.on_expand_container_expand=function(event){var expand_container=event.currentTarget;var expand_container_02=null;if(expand_container.scroll_value!="none")this.util_scroll_to(expand_container.scroll_value);if(expand_container.group_value!="none")for(var i=0,l=this.expand_container_array.length;i<l;i++){expand_container_02=this.expand_container_array[i];if(expand_container_02.group_value==expand_container.group_value&&expand_container_02!==expand_container)expand_container_02.collapse()}};
...
roji.page.Default=function(options,element){manic.page.Page.call(this,options);this.options=$.extend(this.options,roji.page.Default.DEFAULT,options);this.desktop_header=null;this.mobile_header=null;this.mailing_list=null;this.page_wrapper=$("#page-wrapper");this.page_wrapper_content=$("#page-wrapper-content");this.is_page_min_height=false;if(this.body.hasClass("min-height-version")==true)this.is_page_min_height=true;this.is_page_min_height_mobile=false;if(this.body.hasClass("min-height-mobile-version")==
true)this.is_page_min_height_mobile=true;this.desktop_header_element=$("#desktop-header");this.mobile_header_element=$("#mobile-header");this.desktop_footer_element=$("#desktop-footer");this.mobile_footer_element=$("#mobile-footer");this.mobile_header_expanded_element=$("#mobile-header-expanded");console.log("roji.page.Default: init")};goog.inherits(roji.page.Default,manic.page.Page);roji.page.Default.DEFAULT={};roji.page.Default.EVENT_01="";
roji.page.Default.prototype.init=function(){roji.page.Default.superClass_.init.call(this);if($("#desktop-header").length!=0)this.desktop_header=new roji.component.DesktopHeader({},$("#desktop-header"));if($("#mobile-header").length!=0&&$("#mobile-header-expanded").length!=0)this.mobile_header=new roji.component.MobileHeader({},$("#mobile-header"));if($("#mailing-list-popup-container").length!=0)this.mailing_list=new roji.component.MailingList({},$("#mailing-list-popup-container"));this.blog_init();
...
roji.page.Default.prototype.blog_init=function(){$(".load-more-btn").on("click",function(e){e.preventDefault();$(e.currentTarget).text("Loading...");var link=$(".next-page a").attr("href");if(link!="")this.sendLoadMoreProductsRequest(link);else $(e.currentTarget).parent().parent().hide()}.bind(this))};
roji.page.Default.prototype.sendLoadMoreProductsRequest=function(url){$.get(url,function(response){var $result=$(response).find("#page-blog-content");var $next=$(response).find(".next-page a");var new_link=$next.attr("href");if(typeof new_link!="undefined")$(".next-page a").attr("href",new_link);else $(".next-page a").attr("href","");var html=$result.html();$("#page-blog-content").append(html);$(".load-more-btn").text("load more")})};goog.provide("roji.page.Home");goog.require("goog.events.Event");goog.require("goog.events.EventTarget");goog.require("roji.page.Default");goog.require("roji.component.HomeMasonry");goog.require("roji.component.HomeInstagramSlider");roji.page.Home=function(options,element){roji.page.Default.call(this,options,element);this.options=$.extend(this.options,roji.page.Home.DEFAULT,options);this.home_masonry=null;this.home_instagram_slider=null;console.log("roji.page.Home: init")};
...
roji.page.Home.prototype.create_home_masonry=function(){if($("#page-home-masonry-section").length!=0){this.home_masonry=new roji.component.HomeMasonry({},$("#page-home-masonry-section"));goog.events.listen(this.home_masonry,roji.component.HomeMasonry.MASONRY_UPDATE,function(event){this.update_page_layout()}.bind(this))}};
roji.page.Home.prototype.create_home_instagram_slider=function(){if($("#page-home-instagram-slider").length!=0)this.home_instagram_slider=new roji.component.HomeInstagramSlider({},$("#page-home-instagram-slider"))};roji.page.Home.prototype.private_method_04=function(){};roji.page.Home.prototype.private_method_05=function(){};roji.page.Home.prototype.private_method_06=function(){};roji.page.Home.prototype.public_method_01=function(){};roji.page.Home.prototype.public_method_02=function(){};
