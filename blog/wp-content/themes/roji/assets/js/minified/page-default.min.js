...
roji.page.Default.prototype.sendLoadMoreProductsRequest=function(url){$.get(url,function(response){var $result=$(response).find("#page-blog-content");var $next=$(response).find(".next-page a");var new_link=$next.attr("href");if(typeof new_link!="undefined")$(".next-page a").attr("href",new_link);else $(".next-page a").attr("href","");var html=$result.html();$("#page-blog-content").append(html);$(".load-more-btn").text("load more")})};
