...
roji.page.Default=function(options,element){manic.page.Page.call(this,options);this.options=$.extend(this.options,roji.page.Default.DEFAULT,options);this.desktop_header=null;this.mobile_header=null;this.mailing_list=null;this.page_wrapper=$("#page-wrapper");this.page_wrapper_content=$("#page-wrapper-content");this.is_page_min_height=false;if(this.body.hasClass("min-height-version")==true)this.is_page_min_height=true;this.desktop_header_element=$("#desktop-header");this.mobile_header_element=$("#mobile-header");
this.desktop_footer_element=$("#desktop-footer");this.mobile_footer_element=$("#mobile-footer");console.log("roji.page.Default: init")};goog.inherits(roji.page.Default,manic.page.Page);roji.page.Default.DEFAULT={};roji.page.Default.EVENT_01="";
