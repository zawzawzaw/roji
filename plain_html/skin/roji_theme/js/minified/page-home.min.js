...
else this.element.attr("data-label",current_label);if(manic.IS_MOBILE==true)this.dispatchEvent(new goog.events.Event(manic.ui.Dropdown.ON_CHANGE))};goog.provide("manic.page.Page");goog.require("goog.events.Event");goog.require("goog.events.EventTarget");goog.require("goog.userAgent");goog.require("goog.userAgent.product");goog.require("manic");goog.require("manic.ui.FormCheck");goog.require("manic.ui.Dropdown");goog.require("manic.ui.ImageContainer");goog.require("manic.ui.VideoContainer");goog.require("manic.ui.ExpandContainer");
...
manic.page.Page.prototype.create_video_container=function(){var arr=$(".manic-video-container").not(".not-default-version");var video_container=null;var item=null;for(var i=0,l=arr.length;i<l;i++){item=$(arr[i]);video_container=new manic.ui.VideoContainer({},item)}};
...
this.window_hash_02,this.window_hash_03)}}else this.on_scroll_to_no_target()};manic.page.Page.prototype.on_scroll_to_no_target=function(){this.scroll_to(0)};goog.exportSymbol("manic.page.Page",manic.page.Page);goog.provide("roji.page.Default");goog.require("goog.events.Event");goog.require("goog.events.EventTarget");goog.require("manic.page.Page");goog.require("roji.component.DesktopHeader");goog.require("roji.component.MobileHeader");roji.page.Default=function(options,element){manic.page.Page.call(this,options);this.options=$.extend(this.options,roji.page.Default.DEFAULT,options);this.desktop_header=null;this.mobile_header=null;console.log("roji.page.Default: init")};goog.inherits(roji.page.Default,manic.page.Page);
roji.page.Default.DEFAULT={};roji.page.Default.EVENT_01="";roji.page.Default.prototype.init=function(){roji.page.Default.superClass_.init.call(this);if($("#desktop-header").length!=0)this.desktop_header=new roji.component.DesktopHeader({},$("#desktop-header"));if($("#mobile-header").length!=0&&$("#mobile-header-expanded").length!=0)this.mobile_header=new roji.component.MobileHeader({},$("#mobile-header"));console.log("roji.page.Default: init")};
roji.page.Default.prototype.update_page_layout=function(){roji.page.Default.superClass_.update_page_layout.call(this);if(manic.IS_MOBILE_HEADER==false);else;};roji.page.Default.prototype.scroll_to_target=function(str_param,str_param_2,str_param_3){roji.page.Default.superClass_.scroll_to_target.call(this,str_param,str_param_2,str_param_3)};roji.page.Default.prototype.on_scroll_to_no_target=function(){roji.page.Default.superClass_.on_scroll_to_no_target.call(this)};goog.provide("roji.page.Home");goog.require("goog.events.Event");goog.require("goog.events.EventTarget");goog.require("roji.page.Default");roji.page.Home=function(options,element){roji.page.Default.call(this,options,element);this.options=$j.extend(this.options,roji.page.Home.DEFAULT,options);console.log("roji.page.Home: init")};goog.inherits(roji.page.Home,roji.page.Default);roji.page.Home.DEFAULT={};roji.page.Home.EVENT_01="";roji.page.Home.prototype.init=function(){roji.page.Home.superClass_.init.call(this)};
roji.page.Home.prototype.private_method_02=function(){};roji.page.Home.prototype.private_method_03=function(){};roji.page.Home.prototype.private_method_04=function(){};roji.page.Home.prototype.private_method_05=function(){};roji.page.Home.prototype.private_method_06=function(){};roji.page.Home.prototype.public_method_01=function(){};roji.page.Home.prototype.public_method_02=function(){};roji.page.Home.prototype.public_method_03=function(){};roji.page.Home.prototype.public_method_04=function(){};
roji.page.Home.prototype.public_method_05=function(){};roji.page.Home.prototype.public_method_06=function(){};roji.page.Home.prototype.on_event_handler_01=function(event){};roji.page.Home.prototype.on_event_handler_02=function(event){};roji.page.Home.prototype.on_event_handler_03=function(event){};roji.page.Home.prototype.on_event_handler_04=function(event){};roji.page.Home.prototype.sample_method_calls=function(){roji.page.Home.superClass_.method_02.call(this);this.dispatchEvent(new goog.events.Event(roji.page.Home.EVENT_01))};
roji.page.Home.prototype.update_page_layout=function(){roji.page.Home.superClass_.update_page_layout.call(this)};roji.page.Home.prototype.scroll_to_target=function(str_param,str_param_2,str_param_3){roji.page.Home.superClass_.scroll_to_target.call(this,str_param,str_param_2,str_param_3)};roji.page.Home.prototype.on_scroll_to_no_target=function(){roji.page.Home.superClass_.on_scroll_to_no_target.call(this)};
