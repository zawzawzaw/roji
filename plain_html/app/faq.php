...
<body class="min-height-version min-height-mobile-version">
  ...
  </article> <!-- page-faq-title-section -->
  ...
  <article id="page-faq-content-section" class="visible-md visible-lg">
    <div id="page-faq-content-section-bg">
    ...
    <div class="container-fluid has-breakpoint">
      <div class="row">
        <div class="col-md-2">
          <div id="page-faq-sidebar-width"></div>
          <div id="page-faq-sidebar">
            <nav>
              <ul>
                <li data-value="tea" class="selected"><a href="#tea">Tea</a></li>
                <li data-value="well-being"><a href="#well-being">Well-being</a></li>
                <li data-value="matcha"><a href="#matcha">Matcha</a></li>
        ...
        <div class="col-md-10">
          ...
          <div id="page-faq-content-width"></div>
          <div id="page-faq-content">
            ...
            <div class="page-faq-content-item open-version" data-value="tea">
            ...
            <!--
              __        _______ _     _       ____  _____ ___ _   _  ____
              \ \      / / ____| |   | |     | __ )| ____|_ _| \ | |/ ___|
               \ \ /\ / /|  _| | |   | |     |  _ \|  _|  | ||  \| | |  _
                \ V  V / | |___| |___| |___  | |_) | |___ | || |\  | |_| |
                 \_/\_/  |_____|_____|_____| |____/|_____|___|_| \_|\____|

            -->

            <div class="page-faq-content-item" data-value="well-being">
              <div class="page-faq-item-container">
            ...
            <div class="page-faq-content-item" data-value="matcha">
              <div class="page-faq-item-container">
            ...
            <!--
               ____  ____  _______        _____ _   _  ____
              | __ )|  _ \| ____\ \      / /_ _| \ | |/ ___|
              |  _ \| |_) |  _|  \ \ /\ / / | ||  \| | |  _
              | |_) |  _ <| |___  \ V  V /  | || |\  | |_| |
            ...
            <div class="page-faq-content-item" data-value="brewing-and-preserving">
              <div class="page-faq-item-container">
            ...
            <div class="page-faq-content-item" data-value="shipping-and-account">
              <div class="page-faq-item-container">
            ...
            <div class="page-faq-content-item" data-value="trade">
              <div class="page-faq-item-container">
