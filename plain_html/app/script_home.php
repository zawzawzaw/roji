  ...
  <?php if ($is_debug == true): ?>
    ...
    <!-- Home Masonry -->
    <script type="text/javascript" src="../skin/roji_theme/libs/isotope/isotope.pkgd.js"></script>
    <script type="text/javascript" src="../skin/roji_theme/libs/isotope/packery-mode.pkgd.js"></script>
    <script type="text/javascript" src="../skin/roji_theme/libs/isotope/fit-columns.js"></script>

    <!-- Home Instagram Slider -->
    <script type="text/javascript" src="../skin/roji_theme/libs/instafeed/instafeed.min.js"></script>
    ...
    <script type="text/javascript">
      goog.require('roji.page.Home');

      jQuery(document).ready(function($) {
        page = new roji.page.Home({});    
      });
    </script>
