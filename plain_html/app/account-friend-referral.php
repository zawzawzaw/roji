      ...
      <div class="row">
        ...
        <div class="col-md-9 col-sm-10 col-xs-12">
          <div id="page-account-title">
            <h1>Get your friends to enjoy Roji Tea with you.</h1>
          ...
          <div id="page-account-sidebar">
            ...
            <nav>
              <ul>
                ...
                <li class="selected">Friend referral</li>
        ...
        <div class="col-md-10 col-tablet-landscape-11 col-sm-10 col-xs-12">
          ...
          <div id="page-account-content">
                  ...
                  <div class="col-sm-4">
                    ...
                    <div class="referral-header-item first-version">
                      ...
                      <div class="detail-item">
                        ...
                        <p>Get your friends to enjoy Roji Tea with you at www.rojicha.com</p>
                      </div>
                    </div>
            ...
            <div id="page-account-friend-referral-form-container" class="sans-container-fluid-mobile">
              ...
              </form> <!-- page-account-friend-referral-form -->
            </div>
