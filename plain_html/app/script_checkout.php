  ...
  <?php if ($is_debug == true): ?>
    ...
    <script type="text/javascript">
      goog.require('roji.page.Checkout');

      jQuery(document).ready(function($) {
        page = new roji.page.Checkout({});    
      });
    </script>
