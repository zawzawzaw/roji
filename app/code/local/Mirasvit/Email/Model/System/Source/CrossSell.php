...
class Mirasvit_Email_Model_System_Source_CrossSell
{
    ...
    public static function toArray()
    {
        $result = array(
            ...
            self::MAGE_NEW => Mage::helper('email')->__('New arrival products'),
            ...
            self::IWD_ARP => Mage::helper('email')->__('IWD Auto Related Products'),
        );
