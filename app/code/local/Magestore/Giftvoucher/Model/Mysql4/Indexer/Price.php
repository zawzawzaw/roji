...
class Magestore_Giftvoucher_Model_Mysql4_Indexer_Price extends Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Indexer_Price_Default {
    ...
    protected function _prepareFinalPriceData($entityIds = null) {
        ...
        $select = $write->select()
                ...
                ->join(
                        array('pw' => $this->getTable('catalog/product_website')), 'pw.product_id = e.entity_id AND pw.website_id = cw.website_id', array())
                ->joinLeft(
        ...
        if (version_compare(Mage::getVersion(), '1.7.0.0', '>=')) {
            ...
            $select->joinLeft(
                    array('gp' => $this->_getGroupPriceIndexTable()), 'gp.entity_id = e.entity_id AND gp.website_id = cw.website_id'
