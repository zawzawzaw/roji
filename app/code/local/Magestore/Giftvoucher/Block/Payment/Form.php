...
class Magestore_Giftvoucher_Block_Payment_Form extends Mage_Payment_Block_Form {
    ...
    protected $checkoutLayout = 'giftvoucher/payment/form.phtml';

    protected function _construct() {
        $store_Id = Mage::app()->getStore()->getId();
        parent::_construct();

        if (Mage::helper('giftvoucher')->getGeneralConfig('active', $store_Id) && Mage::getStoreConfig('giftvoucher/interface_payment/show_gift_card')) {
            ...
            if (isset($class) && $class != null) {
                ...
                if (($extensionName != 'Mage_Checkout') && ($extensionName != 'Magestore_Giftvoucher')) {
                    if (is_file(Mage::getDesign()->getTemplateFilename('giftvoucher' . DS . 'onestepcheckout' . DS . $extensionName . DS . 'form.phtml')))
                        $this->checkoutLayout = 'giftvoucher/onestepcheckout/' . $extensionName . '/form.phtml';
                }
                $this->setTemplate($this->checkoutLayout);
            }
        }
    }
