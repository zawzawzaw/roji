...
//            'required' => true,
			...
			<span>&nbsp;&nbsp;' . Mage::helper('giftvoucher')->__('Recommended size: ') . '<span id="giftcard-notes-top" style="display: none">600x190</span><span id="giftcard-notes-center" style="display: none">600x365</span><span id="giftcard-notes-left" style="display: none">250x365</span>' . Mage::helper('giftvoucher')->__('&nbsp;&nbsp;Support gif, jpg, png files.') . '</span>
			<br /><br />
