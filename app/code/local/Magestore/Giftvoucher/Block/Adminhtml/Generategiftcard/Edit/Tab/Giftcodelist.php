...
class Magestore_Giftvoucher_Block_Adminhtml_Generategiftcard_Edit_Tab_Giftcodelist extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        $collection = Mage::getModel('giftvoucher/giftvoucher')->getCollection()->addFieldToFilter('template_id', $id)->joinHistory();
