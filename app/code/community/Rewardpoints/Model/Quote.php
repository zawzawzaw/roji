...
/*if (Mage::getConfig()->getModuleConfig('Amasty_Coupons')->is('active', 'true')){
    //class Rewardpoints_Model_Quote_Abstract extends Amasty_Coupons_Model_Sales_Quote
    class Rewardpoints_Model_Quote_Abstract extends Mage_Sales_Model_Quote
    {
...
class Rewardpoints_Model_Quote extends Rewardpoints_Model_Quote_Abstract
{
