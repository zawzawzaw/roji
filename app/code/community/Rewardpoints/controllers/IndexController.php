...
class Rewardpoints_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function removequotationAction(){
        ...
        $session->addSuccess($this->__('Rebate redemption was removed.', $email));
    ...
    public function quotationAction(){
        ...
        if (!Mage::helper('giftvoucher')->getGeneralConfig('use_with_coupon') && ($checkout_session->getUseGiftCreditAmount() > 0 || $checkout_session->getGiftVoucherDiscount() > 0)) {
            ...
            Mage::getSingleton('checkout/session')->addSuccess($this->__('You have redeemed your rebates', $email));
        }        
