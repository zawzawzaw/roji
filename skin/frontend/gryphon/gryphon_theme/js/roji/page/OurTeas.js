...
roji.page.OurTeas = function(options, element) {
  ...
  this.options = $j.extend(this.options, roji.page.OurTeas.DEFAULT, options);
...
roji.page.OurTeas.prototype.create_map = function() {
  ...
  if ($j('#page-our-teas-map-section').length != 0) {
    this.map = new roji.component.OurTeasMap({}, $j('#page-our-teas-map-section'));
  }
