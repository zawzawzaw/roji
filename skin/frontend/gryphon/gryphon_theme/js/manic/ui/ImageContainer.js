...
manic.ui.ImageContainer = function(options, element) {
  ...
  this.options = $j.extend({}, manic.ui.ImageContainer.DEFAULT, options);
  ...
  //$j([this.image_element.attr('src')]).preloadImages(this.on_image_load_complete.bind(this))
...
manic.ui.ImageContainer.prototype.set_image_src = function(str_param) {
  ...
  //$j([str_param]).preloadImages(this.on_image_load_complete.bind(this));
...
manic.ui.ImageContainer.prototype.on_image_load_complete = function(event) {
  ...
  var loaded_image_element = $j(this.preloader.getResult(this.current_image));
