...
manic.ui.Masonry = function(options, element) {
  ...
  //this.options = $j.extend(this.options, manic.ui.Masonry.DEFAULT, options);         // if has parent.
  this.options = $j.extend({}, manic.ui.Masonry.DEFAULT, options);
  ...
  if( this.options['sortable'] == true){
    this.container.sortable({
      ...
      //update: $j.proxy(this.on_list_sortable_change,this)        // update, stop
    });
