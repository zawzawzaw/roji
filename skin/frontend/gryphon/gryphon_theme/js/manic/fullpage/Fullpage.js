...
manic.fullpage.Fullpage = function(options, element) {
  ...
  this.options = $j.extend({}, manic.fullpage.Fullpage.DEFAULT, options);
...
manic.fullpage.Fullpage.prototype.initial_scroll_to_target = function() {
  //$j.fn.fullpage.scrollToAnchorPublic();
  ...
  */
  ...
  if (section != '') {
    if (slide != null) {
      ...
      $j.fn.fullpage.silentMoveTo(section,slide);
    } else {
      $j.fn.fullpage.silentMoveTo(section);
...
manic.fullpage.Fullpage.prototype.disable_scroll = function() {
  ...
  $j.fn.fullpage.setKeyboardScrolling (false);
  $j.fn.fullpage.setRecordHistory(false);
};
manic.fullpage.Fullpage.prototype.enable_scroll = function() {
  $j.fn.fullpage.setAllowScrolling(true);
  $j.fn.fullpage.setKeyboardScrolling (true);
  $j.fn.fullpage.setRecordHistory(true);
};
