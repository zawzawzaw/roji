...
manic.google.Map2 = function(options, element) {
  ...
  this.options = $j.extend({}, manic.google.Map2.DEFAULT, options);
  this.element = element;

  // if class has parent
  //goog.events.EventTarget.call(this, options, element);
  //this.options = $j.extend(this.options, manic.google.Map2.DEFAULT, options);
...
manic.google.Map2.prototype.create_google_map = function(){
  ...
  this.home_marker.addListener('click', function(event) {
    this.google_map.panTo(new google.maps.LatLng(this.center_lat, this.center_lng));
  }.bind(this));
