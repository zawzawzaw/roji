...
manic.framework.Fullpage = function(options, element) {
  ...
  this.options = $j.extend({}, manic.framework.Fullpage.DEFAULT, options);
...
manic.framework.FullpageSection = function(options, element) {
  ...
  this.options = $j.extend({}, manic.framework.FullpageSection.DEFAULT, options);
  this.element = element;
  ...
  for (var i = 0, l = arr.length; i < l; i++) {
    this.address_array[i] = $j(arr[i]).attr('data-anchor');
  }
...
manic.framework.FullpageSlide = function(options, element) {
  ...
  this.options = $j.extend({}, manic.framework.FullpageSlide.DEFAULT, options);
  this.element = element;
