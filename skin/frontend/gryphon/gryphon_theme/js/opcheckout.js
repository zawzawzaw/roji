...
//            }
    ...
    nextStep: function(transport){
        ...
        $j("#page-shopping-cart-sidebar-address").show();
...
Shipping.prototype = {
    ...
    changePageTitle: function() {
        $j("#page-checkout-title").find("h1").text("Please check your details before confirming your order.");
        $j("#page-checkout-sidebar-mobile").find("p").text("2. Shipping & Billing");
    },
...
//        $('billing:use_for_shipping_yes').checked = flag;
    ...
    syncWithBilling: function () {
        ...
        $j(billingAddressInputs).each(function(index, value){
            $j(shippingAddressInputs[index]).val($j(value).val());
        });
        ...
        if (!$('billing-address-select') || !$('billing-address-select').value) {                   
            ...
            $j('input[name="shipping[telephone]"]').intlTelInput("setNumber", $j('input[name="billing[telephone]"]').val());
            $j('input[name="shipping[fax]"]').intlTelInput("setNumber", $j('input[name="billing[fax]"]').val());
...
Review.prototype = {
    ...
    changePageTitle: function() {
        $j("#page-checkout-title").find("h1").text("Review your order.");
        $j("#page-checkout-sidebar-mobile").find("p").text("3. order confirmation");
    },
