...
roji.page.Default.prototype.on_remove_header_cart_item=function(event){event.preventDefault();var item_id=$j(event.currentTarget).data("item-id");var request=$j.ajax({url:"/discovertea/index/deletecartitem",method:"POST",data:{item_id:item_id},dataType:"html"});request.done(function(){this.update_header_cart()}.bind(this))};
