...
var currentVal=parseInt($qty.val());if(!isNaN(currentVal)&&currentVal>1){currentVal=currentVal-1;$qty.val(currentVal);var product_price=$j("#page-product-detail-content").find(".regular-price").html();var currency_symbol=$j("#page-product-detail-form").find(".form-total-value").data("currency");product_price=product_price.replace(/^\D+/g,"");var total_price=product_price*currentVal;$j("#page-product-detail-form").find(".form-total-value").html(currency_symbol+total_price.toFixed(2))}});console.log("roji.page.Default: init")};
