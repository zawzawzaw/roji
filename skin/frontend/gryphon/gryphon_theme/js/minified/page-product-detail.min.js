...
$j("#page-product-detail-form .form-quantity").find(".form-quantity-minus-btn").click(this.on_quantity_minus_btn_click.bind(this));$j("#page-product-detail-form .form-quantity").find(".form-quantity-input-txt").on("input",this.on_quantity_input_change.bind(this))};roji.page.ProductDetail.prototype.set_default_total_price=function(){$j("#page-product-detail-form").find(".form-total-value").html(this.product_price)};roji.page.ProductDetail.prototype.private_method_05=function(){};
roji.page.ProductDetail.prototype.private_method_06=function(){};roji.page.ProductDetail.prototype.public_method_01=function(){};roji.page.ProductDetail.prototype.public_method_02=function(){};
