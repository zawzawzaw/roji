...
$j("#page-product-detail-form .form-quantity").find(".form-quantity-minus-btn").click(this.on_quantity_minus_btn_click.bind(this))};roji.page.ProductDetail.prototype.set_default_total_price=function(){$j("#page-product-detail-form").find(".form-total-value").html(this.product_price)};roji.page.ProductDetail.prototype.private_method_05=function(){};roji.page.ProductDetail.prototype.private_method_06=function(){};roji.page.ProductDetail.prototype.public_method_01=function(){};
roji.page.ProductDetail.prototype.public_method_02=function(){};roji.page.ProductDetail.prototype.on_quantity_plus_btn_click=function(event){event.preventDefault();var $qty=$j(event.currentTarget).parent().find(".qty");var currentVal=parseInt($qty.val());if(!isNaN(currentVal)){currentVal=currentVal+1;$qty.val(currentVal);this.total_price=this.product_price_int*currentVal;$j("#page-product-detail-form").find(".form-total-value").html(this.currency_symbol+this.total_price.toFixed(2))}};
roji.page.ProductDetail.prototype.on_quantity_minus_btn_click=function(event){event.preventDefault();var $qty=$j(event.currentTarget).parent().find(".qty");var currentVal=parseInt($qty.val());if(!isNaN(currentVal)&&currentVal>1){currentVal=currentVal-1;$qty.val(currentVal);this.total_price=this.product_price_int*currentVal;$j("#page-product-detail-form").find(".form-total-value").html(this.currency_symbol+this.total_price.toFixed(2))}};roji.page.ProductDetail.prototype.update_page_layout=function(){roji.page.ProductDetail.superClass_.update_page_layout.call(this)};
