...
this.desktop_footer_element=$j("#desktop-footer");this.mobile_footer_element=$j("#mobile-footer");$j("#page-product-detail-form .form-quantity").find(".form-quantity-plus-btn").click(function(e){e.preventDefault();var $qty=$j(this).parent().find(".qty");var currentVal=parseInt($qty.val());if(!isNaN(currentVal))$qty.val(currentVal+1);var product_price=$j("#page-product-detail-content").find(".regular-price");product_price=product_price.substring(1);$j("#page-product-detail-form").find(".form-total-value").text(product_price*
currentVal)});$j("#page-product-detail-form .form-quantity").find(".form-quantity-minus-btn").click(function(e){e.preventDefault();var $qty=$j(this).parent().find(".qty");var currentVal=parseInt($qty.val());if(!isNaN(currentVal)&&currentVal>0)$qty.val(currentVal-1);var product_price=$j("#page-product-detail-content").find(".regular-price");product_price=product_price.substring(1);$j("#page-product-detail-form").find(".form-total-value").text(product_price*currentVal)});console.log("roji.page.Default: init")};
goog.inherits(roji.page.Default,manic.page.Page);roji.page.Default.DEFAULT={};roji.page.Default.EVENT_01="";
