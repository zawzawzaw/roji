...
this.desktop_footer_element=$j("#desktop-footer");this.mobile_footer_element=$j("#mobile-footer");console.log("roji.page.Default: init")};goog.inherits(roji.page.Default,manic.page.Page);roji.page.Default.DEFAULT={};roji.page.Default.EVENT_01="";
