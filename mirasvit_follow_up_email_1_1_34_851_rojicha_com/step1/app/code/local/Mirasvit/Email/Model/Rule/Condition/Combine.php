        ...
        $conditions = array_merge_recursive($conditions, array(
            ...
            array(
                'value' => array(
                    ...
                    array(
                        'label' => Mage::helper('email')->__('Attribute Value Comparison'),
                        'value' => 'email/rule_condition_product_different',
                    ),
                ),
                'label' => 'Products'
            ),
            array(
                'value' => array(
                    array(
                        'value' => 'email/rule_condition_email_trigger',
                        'label' => Mage::helper('email')->__('Recipient has pending emails')
                    )
                ),
