...
class Mirasvit_Email_Adminhtml_Email_QueueController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function deleteAction()
    {
        ...
        Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('email')->__('The mail was deleted.'));
    ...
    public function massDeleteAction()
    {
        ...
        Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('email')->__('The mails were deleted.'));
